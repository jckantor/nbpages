...
def nbsetup():
    ...
    # backup any existing readme file to avoid accidental overwriting
    if os.path.isfile("README.md"):
        print("- checkpoint backup of README.md")
        os.rename("README.md", datetime.datetime.now().strftime("README.md.%Y%M%dT%H%M%S"))
